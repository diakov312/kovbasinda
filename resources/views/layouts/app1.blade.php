...
<head>
    ...
    <script type="text/javascript" >
        (function (d, w, c) {
            (w[c] = w[c] || []).push(function() {
                try {
                    w.yaCounter49897681 = new Ya.Metrika2({
                        id:49897681,
                        clickmap:true,
                        trackLinks:true,
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/49897681" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>
<body>
    @yield('content')
                ...
                <div class="container">
                        ...
                        <div class="12u 12u(mobile)" id="myWork">
                            <section class="box style1">
                                ...
                                <h5>Рекламное интернет-агентство Волекс</h5>
                                <p>C мая 2018г. по настоящее время работа back-end разработчиком. В обязаности
                                входит работа с сайтами и внутренними системами компании. Сайты работают на различных cms,
                                таких как bitrix-1c, modx, внутренняя самописная cms агенства. Так же есть проект по
                                автоматизации контекстной рекламы на yandex direct, написанный на laravel.</p>
                            </section>
                        </div>
                            <section></section>
                        <div class="12u 12u(mobile)" id="mySkills">
                            <section class="box style1">
                                ...
                                знание <b>php</b>, знание фреймворка <b>laravel</b>. Так же приходилось писать
                                    несложные программы на <b>C#</b> и работать с <b>yandex direct api</b>.</p>
                                <h5>Другие навыки.</h5>
